...
- Конвертация HTML в PDF через CDP (порт 9222): `.cline_scripts/cdp-print-to-pdf.ps1 -HtmlPath <html> -PdfPath <pdf>` (Page.printToPDF, формат A4, printBackground). Пример использования: `Предложения по Main.pdf` (20.08.2026).
